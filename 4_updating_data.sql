...
INSERT INTO user2 (name, email, gender, date_of_birth, salary) VALUES
...
update user2 set salary =45000 where id=1;
select * from user2;

update user2 set gender= "Female" where id=1;
select * from user2;

update user2 set date_of_birth="2000-05-14", name="Arav" where id=1;
select * from user2;

-- increase salary by 10k whose salary is less than 60k
update user2 set salary=salary+10000 where salary<=60000 and id>0;
select * from user2;
-- now lets check ishaan salaray earlier it was 45000
select * from user2 where name="Ishaan";